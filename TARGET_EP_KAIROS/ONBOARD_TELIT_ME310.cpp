...
ONBOARD_TELIT_ME310::ONBOARD_TELIT_ME310(FileHandle *fh) : TELIT_ME310(fh, GPIO_CELL_ON_OFF, true)
{
}
...
nsapi_error_t ONBOARD_TELIT_ME310::init()
{
    ...
    _at->at_cmd_discard("#PORTCFG", "=", "%d", EP_KAIROS_PORT_CONFIGURATION_VARIANT);
...
void ONBOARD_TELIT_ME310::press_power_button(int time_ms)
{
    ...
    gpio_init_out_ex(&gpio, GPIO_CELL_ON_OFF, 1);
    // gpio_write(&gpio, 0);
...
void ONBOARD_TELIT_ME310::onboard_modem_init()
{
    ...
    gpio_init_out_ex(&gpio, GPIO_CELL_PWR_EN, 0);
    gpio_write(&gpio, 1);
}
...
void ONBOARD_TELIT_ME310::onboard_modem_deinit()
{
    ...
    gpio_init_out_ex(&gpio, GPIO_CELL_PWR_EN, 1);
    gpio_write(&gpio, 0);
}
...
void ONBOARD_TELIT_ME310::onboard_modem_power_down()
{
    ...
    gpio_init_out_ex(&gpio, GPIO_CELL_ON_OFF, 0);
